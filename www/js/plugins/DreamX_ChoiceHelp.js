...
//=============================================================================
    ...
    Window_ChoiceList.prototype.updateHelp = function () {
        var help = $gameMessage._choiceHelps[this.currentExt()];
        if (help) {
        ...
        var message = $gameMessage._choiceMessages[this.currentExt()];
        var face = $gameMessage._choiceFaces[this.currentExt()];
