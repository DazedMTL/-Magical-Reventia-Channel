...
Scene_Equip.prototype.create = function () {
	...
	this._commandWindow.x = 17;
	this._commandWindow.y = 114;
	...
	this._itemWindow.width = 542;
	this._itemWindow.height = 220;
...
Scene_Equip.prototype.updateLayout = function () {
	...
	this._layoutCommand.x = Moghunter.scEquip_ComLayoutX;
	this._layoutCommand.y = Moghunter.scEquip_ComLayoutY;
	this._layoutCommand.opacity = this._commandWindow.contentsOpacity;
	this._commandWindow.opacity = 0;
	this._layoutSlot.x = Moghunter.scEquip_SlotLayoutX;
	this._layoutSlot.y = Moghunter.scEquip_SlotLayoutY;
	...
	this._layoutItem.x = Moghunter.scEquip_ItemLayoutX;
	this._layoutItem.y = Moghunter.scEquip_ItemLayoutY;
...
Window_Base.prototype.drawItemName = function (item, x, y, width) {
	...
	if (item) {
		...
		this.resetitemListColor();
		this.drawIcon(item.iconIndex, x + 2, y + 2);
		this.drawText(item.name, x + iconBoxWidth, y, width - (iconBoxWidth / 2));
	}
	// for (let i = 0; i < 4; i++) {
	// }
