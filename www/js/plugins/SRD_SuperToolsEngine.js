...
if(!SRD.DataManager_isDatabaseLoad) {

// SRD.notetagsLoaded = false;
// SRD.DataManager_isDatabaseLoad = DataManager.isDatabaseLoad;
// DataManager.isDatabaseLoad = function() {
// 	if(!SRD.DataManager_isDatabaseLoad.apply(this, arguments)) return false;
