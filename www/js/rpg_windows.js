...
Window_Base.prototype.resetOptionColor = function () {
  this.changeTextColor(this.textColor(1));
};

// 메세지 컬러 변경
Window_Base.prototype.resetMsgColor = function () {
  this.changeTextColor(this.textColor(0));
};

Window_Base.prototype.resetitemListColor = function () {
  this.changeTextColor(this.itemListColor());
};
...
// 아이템 색상
Window_Base.prototype.itemListColor = function () {
  return this.textColor(0);
};
...
Window_HorzCommand.prototype.horzWindowWidth = function () {
  return 200;
};
